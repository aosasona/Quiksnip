...
<div class="flex justify-between items-center px-1">
    <div class="flex flex-col gap-1.5">
        <h1 class="text-3xl lg:text-3xl font-medium text-neutral-200 tracking-wide mb-2">Explore</h1>
    ...
    <a href="/new" class="fixed lg:relative bottom-6 right-6 lg:bottom-0 lg:right-0 lg:block bg-green-400 text-[10px] text-neutral-900 font-medium hover:-translate-y-2 cursor-pointer rounded-md lg:rounded p-5 lg:p-0 lg:py-1.5 lg:px-3 my-0 transition-all">
