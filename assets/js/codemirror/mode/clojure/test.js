...
(function () {
  ...
  var coreSymbols1 = [
    ...
    "identity", "if-let", "if-not", "if-some", "ifn?", "import", "in-ns", "layouts", "layouts'", "indexed?", "init-proxy",
  ...
  var coreSymbols2 = [
    ...
    "unchecked-dec-int", "unchecked-divide-int", "unchecked-double", "unchecked-float", "unchecked-layouts", "unchecked-layouts-int",
